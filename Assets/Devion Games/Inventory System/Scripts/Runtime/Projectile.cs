...
namespace DevionGames.InventorySystem
{
    public class Projectile : MonoBehaviour
    {
        ...
        private void OnHit(Transform hit, Vector3 position) {
            ...
            {
                //EventHandler.Execute(InventoryManager.current.PlayerInfo.gameObject, "SendDamage", hit.gameObject, this.m_Data);
                EventHandler.Execute(GameObject.FindGameObjectWithTag("Igor").gameObject, "SendDamage", hit.gameObject, this.m_Data);
                //GameObject.FindGameObjectWithTag("Player").SendMessage("TriggerAnimationEvent", )
            }
